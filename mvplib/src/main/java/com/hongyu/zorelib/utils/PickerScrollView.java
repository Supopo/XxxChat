...
public class PickerScrollView extends View {
    ...
    public void setSelected(String mSelectItem) {
        for (int i = 0; i < mDataList.size(); i++)
            if (TextUtils.equals(mDataList.get(i).getShowConetnt(), mSelectItem)) {
                setSelected(i);
                break;
            }
    }
     ...
     * @param pickers
     */
    public void setSelected(Pickers pickers) {
        for (int i = 0; i < mDataList.size(); i++)
            if (TextUtils.equals(mDataList.get(i).getShowConetnt(), pickers.getShowConetnt())) {
                setSelected(i);
                break;
            }
    }
