    ...
    public void onSetUpView() {
        ...
        if(emojicon != null){
            ...
            if(emojicon.getBigIcon() != 0){
                Glide.with(activity).load(emojicon.getBigIcon()).apply(myOptions).into(imageView);
            }else if(emojicon.getBigIconPath() != null){
                Glide.with(activity).load(emojicon.getBigIconPath()).apply(myOptions).into(imageView);
            }else{
